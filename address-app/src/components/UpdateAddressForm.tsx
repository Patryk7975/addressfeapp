...
export const UpdateAddressForm = ({ address, clientId, onCancelAddingNewAddress, onSubmitAddingNewAddress }: UpdateAddressFormProps) => {
    ...
    const defaultAddress: AddressData = {
        ...
        postOfficeLocation: address != null ? address.postOfficeLocation : null,
        buildingType: address != null ? address.buildingType : null,
    ...
    return (
        <div className="new-address-form">
                ...
                <ul className="new-address-form-usages-ul">
                    {formData.usages.map((e, index) => (
                        <li className="new-address-form-usages-li" key={index}>
                            ...
                            <Button color="danger" size="small" onClick={() => handleRemoveUsage(index)}>
                                Delete
                            </Button>
                        </li>
                    ))}
            ...
            <div className="add-new-usage-section">
                {!addingUsage && <Button size="small" onClick={() => setAddingUsage(true)}>Add usage</Button>}
            ...
            {address !== null && <div className="add-new-address-bussttons">
                <Button color="secondary" onClick={onCancelAddingNewAddress} >
                    Cancel update
                </Button>
